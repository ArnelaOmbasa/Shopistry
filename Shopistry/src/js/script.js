...
// Select handler that filters printed products on Home-Page by category 
...
function showProduct() {
    ...
    $("#thumb2").attr("src", "src/img/" + idProduct + "_thumb2.webp").click(changeThumb);
    $("#thumb3").attr("src", "src/img/" + idProduct + "_thumb3.webp").click(changeThumb);
}
